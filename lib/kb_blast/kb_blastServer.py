...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'kb_blast'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from kb_blast.kb_blastImpl import kb_blast  # noqa @IgnorePep8
impl_kb_blast = kb_blast(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'kb_blast'
